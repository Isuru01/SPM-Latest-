...
function Chatbot() {
  ...
  return (
    <div className="App">
      ...
      {showImage && <img className='img1' src='https://chat360.io/wp-content/uploads/2021/05/Top-10-website-chatbot-examples-of-2022.svg' alt="robot"/>}
          ...
          <MainContainer>
            <ChatContainer>
              <MessageList
                ...
                typingIndicator={isTyping ? <TypingIndicator content="Programming Assistance is typing" /> : null}
              >
